<?php
/*
This page changes our site settings. It's accessible only to administrative users. It updates the table in the database that keeps track of many of the site globals.
*/
